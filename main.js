        ...
        projects.filter(p => p.published).forEach(project => {
            ...
            portfolioItem.innerHTML = `
                <div class="project-image clickable-project" data-project="custom-${project.id}">
                    <img src="${project.imageUrl || 'https://via.placeholder.com/600x400/f5f5f5/666666?text=Project+Image'}" alt="${project.title}" onerror="this.src='https://via.placeholder.com/600x400/f5f5f5/666666?text=Project+Image'">
                    <div class="overlay">
                        <h2>${project.title}</h2>
                        <p>${project.meta || ''}</p>
